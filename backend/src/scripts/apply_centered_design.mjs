...
export function buildCenteredBadgeSvg() {
  const boxW = 556;
  const boxH = 128;
  const leftMargin = 32;
...
export async function applyCenteredDesign() {
  ...
  console.log('\n✅ Perfectly centered badge design applied to all production assets!');
}

applyCenteredDesign().catch(console.error);
